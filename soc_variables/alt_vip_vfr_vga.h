#ifndef _ALTERA_ALT_VIP_VFR_VGA_H_
#define _ALTERA_ALT_VIP_VFR_VGA_H_
...
/*
 * This file contains macros for module 'alt_vip_vfr_vga' and devices
...
#endif /* _ALTERA_ALT_VIP_VFR_VGA_H_ */
